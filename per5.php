...
if(isset($_POST['input']))
{
	...
	$sql="INSERT INTO db_data(npm,nama,jurusan,jk,alamat) VAlUES ('$npm','$nama','$jurusan','$jk','$alamat')";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-4">
                                    <form action="per5.php" method="POST" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="jk" id="optionsRadiosInline1" value="L" checked> Laki Laki
                                            </label>
                                            <label class="radio-inline">
