                                ...
                                <tbody>
                                    <?php
                                       include("./koneksi_per5.php");
                                        $db_data = mysqli_query($conn, "SELECT * from db_data");
                                        $no=1;
                                        foreach ($db_data as $row){
                                            ...
                                            echo "<td>";
                                            echo "<a href='edit.php?no=".$row['no']."'>EDIT</a>   ";
                                             echo "<a href='hapus.php?no=".$row['no']."'>HAPUS</a>";
